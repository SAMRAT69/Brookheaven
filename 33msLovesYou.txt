...
local Window = Libary:MakeWindow({
    Title = "SammyHub | Brookhaven RP ",
    SubTitle = "by: SAMRAT",
    LoadText = "SammyHub",
    Flags = "SammyHub_Brookheaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "Samrat." })
InfoTab:AddParagraph({ "Colabeator:", "Samrat" })
InfoTab:AddParagraph({ "Name:", "SammyHub Brookhaven " })
